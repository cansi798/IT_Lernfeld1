...
Vor Ausbildungsbeginn ist der wesentliche Vertragsinhalt in \textbf{Textform} (§~126b BGB)
niederzulegen (§~11 BBiG i.\,d.\,F.\ seit 1.8.2024, BVaDiG) --- eine digitale Übermittlung
(z.\,B.\ PDF) genügt; eine eigenhändige Unterschrift ist nicht mehr erforderlich. Bei der IHK
ist der \textbf{Berufsausbildungsvertrag} zur Eintragung einzureichen. \textbf{Achtung:} Die
Kündigung (§~22 Abs.~3 BBiG) bleibt schriftformpflichtig.
...
\textbf{Wahlberechtigt} (§~60 BetrVG) sind:
\begin{itemize}
  \item alle Beschäftigten unter 18 Jahren \emph{oder}
  \item alle Auszubildenden, die das 25.~Lebensjahr noch nicht vollendet haben.
\end{itemize}

\textbf{Wählbar} (§~61 BetrVG) sind Wahlberechtigte, die am Wahltag das 25.~Lebensjahr
