...
Ein \textbf{Projektteam} ist eine Arbeitsgruppe, deren Zusammenarbeit \emph{befristet} ist und die
kooperativ einen besonderen Auftrag umsetzt. Neben fachlichen Qualifikationen ist ein besonderes
Gemeinschaftsgefühl für den Projekterfolg wichtig.
\end{merksatz}
...
\textbf{10-20-30-Regel:} Nicht mehr als \textbf{10 Folien}, in nicht mehr als \textbf{20 Minuten},
keine Schrift kleiner als \textbf{30 Punkt}.
\end{merksatz}
...
\toprule
\textbf{Abschnitt} & \textbf{Inhalt und Funktion} & \textbf{Zeitanteil}\\
\midrule
