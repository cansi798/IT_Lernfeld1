...
\addlinespace
JAV & JAV (§§ 60/61/70 BetrVG: vertritt Jugendliche unter 18 und Azubis unter 25; § 70 Aufgaben) --- Interessenvertretung der Jugendlichen und Auszubildenden\\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Thema} & \textbf{Kernaussagen}\\
\midrule
Wertschöpfung & Formel: Umsatzerlöse $\pm$ Lagerveränderung $-$ Vorleistungen $-$ Abschreibungen;
