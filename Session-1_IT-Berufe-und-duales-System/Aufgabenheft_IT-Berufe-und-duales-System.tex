...
weichen bewusst vom Lehrbuch-Standort Hamburg mit 52 Mitarbeitenden ab). Die Geschäftsführerin,
Frau Kaya, begrüßt Sie und erklärt den Ablauf der Einführungswoche.
...
(b) \textbf{Richtig}\\
(c) \textbf{Falsch} --- Ausbilder kann nicht jeder ohne Eignungsnachweis werden; er muss persönlich geeignet (§~29 BBiG) und fachlich geeignet sein (§~30 BBiG: einschlägiger Abschluss + AEVO-Prüfung); die IHK überwacht die Eignung; ein gesetzliches Mindestalter gibt es nicht.\\
(d) \textbf{Richtig}
\end{loesung}

\subsection*{Lösung Aufgabe~5}
\begin{loesung}
\textbf{(a)} Eine Verkürzung der Ausbildungszeit ist auf Antrag möglich, wenn anerkannte Bildungsgänge angerechnet werden (z.\,B.\ Hochschulreife, §~7 BBiG) oder ein gemeinsamer Antrag von Ausbildendem und Auszubildendem gestellt wird (§~8 BBiG). Bei besonderen Leistungen ist auch die vorzeitige Zulassung zur Abschlussprüfung möglich (§~45 Abs.~1 BBiG). Leon kann bei der IHK einen entsprechenden Antrag stellen.

\textbf{(b)} Ja, er darf ausbilden, sofern er persönlich geeignet ist (§~29 BBiG) und fachlich geeignet ist (§~30 BBiG). Die fachliche Eignung umfasst einen einschlägigen Abschluss sowie die berufs- und arbeitspädagogische Eignung, die er durch die bestandene AEVO-Prüfung nachgewiesen hat. Ein gesetzliches Mindestalter gibt es nicht --- die früher im Lehrwerk genannte Altersgrenze von 24~Jahren ist veraltet und entspricht nicht dem geltenden Recht (BBiG §§~28--30). Die zuständige IHK überwacht die Eignung.

\textbf{(c)} Teil~1 findet im 4.~Ausbildungshalbjahr (nach ca.\ 18 Monaten) statt. Er prüft den Stoff der Lernfelder 1 bis 6 und ist für alle IT-Berufe gleich (Leitthema: „Einrichten eines IT-gestützten Arbeitsplatzes", 90 Minuten schriftlich). Teil~1 geht mit \textbf{20\,\%} in die Gesamtnote der Abschlussprüfung ein.
\end{loesung}
