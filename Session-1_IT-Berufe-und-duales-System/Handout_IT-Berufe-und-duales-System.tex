...
Projektaufgabe für die Abschlussprüfung.
...
ist in Textform niederzulegen (§~11 BBiG i.\,d.\,F.\ seit 1.\,8.\,2024; BVaDiG) und enthält alle wichtigen Vereinbarungen. Eine digitale Übermittlung (z.\,B.\ PDF) genügt; eigenhändige Unterschrift ist nicht mehr erforderlich.
...
Ausbilder:in & Führt die Ausbildung im Betrieb durch; muss persönlich (§~29 BBiG) und fachlich geeignet (§~30 BBiG) sein; fachliche Eignung = einschlägiger Abschluss + AEVO-Prüfung; ein gesetzliches Mindestalter gibt es nicht\\
...
ist ebenfalls möglich (§~7 Anrechnung beruflicher Vorbildung, §~8 Verkürzung/Verlängerung, §~45 Abs.~1 vorzeitige Zulassung zur Abschlussprüfung bei besonderen Leistungen, BBiG).
...
\midrule
\textbf{Teil 1 (20\,\%)} & Schriftlich, im 4.~Ausbildungshalbjahr (nach ca.\ 18 Monaten), 90 Minuten; Leitthema „Einrichten eines IT-gestützten Arbeitsplatzes" (Lernfelder 1--6); für alle IT-Berufe gleich\\
...
\begin{enumerate}
  ...
  \item Ausbildungsdauer: \textbf{3 Jahre}; Verkürzung nach §~8 BBiG, Anrechnung nach §~7 BBiG, vorzeitige Prüfungszulassung nach §~45 Abs.~1 BBiG möglich.
  \item Die \textbf{gestreckte Abschlussprüfung} besteht aus Teil~1 (20\,\%, im 4.~Ausbildungshalbjahr / nach ca.\ 18 Monaten) und Teil~2 (80\,\%, zum Ausbildungsende mit Projektarbeit).
...
\glossareintrag{Ausbilder:in}{Person im Betrieb, die die Ausbildung praktisch durchführt; muss persönlich geeignet (§~29 BBiG) und fachlich geeignet (§~30 BBiG) sein (einschlägiger Abschluss + AEVO-Prüfung); die zuständige Stelle (IHK) überwacht die Eignung; ein gesetzliches Mindestalter gibt es nicht.}
...
\glossareintrag{Gestreckte Abschlussprüfung}{IHK-Prüfung in zwei zeitlich getrennten Teilen; Teil~1 im 4.~Ausbildungshalbjahr (nach ca.\ 18 Monaten) (20\,\%), Teil~2 zum Ausbildungsende (80\,\%).}
