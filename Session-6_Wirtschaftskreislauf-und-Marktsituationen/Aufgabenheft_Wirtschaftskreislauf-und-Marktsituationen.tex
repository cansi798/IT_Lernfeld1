...
\begin{enumerate}[label=(\alph*)]
  \item \textbf{Nennen} Sie die vier Wirtschaftssubjekte des erweiterten Wirtschaftskreislaufs
...
\begin{enumerate}[label=(\alph*)]
  \item Vier Wirtschaftssubjekte: Haushalte, Unternehmen, \textbf{Staat}, Banken, Ausland
  (im Überblick vier Hauptgruppen, das Ausland als fünfte Ergänzung). Der Staat vereinnahmt
  direkte Steuern von Haushalten und indirekte Steuern über Unternehmen; er gibt diese als
  Staatsausgaben, Transferleistungen und Subventionen aus.
...
\begin{enumerate}[label=(\alph*)]
  ...
  \item Bei 300\,€: Angebot = 800 Stück, Nachfrage = 1\,400 Stück.
  Nachfrage > Angebot → \textbf{Nachfrageüberhang} von 1\,400 $-$ 800 = \textbf{600 Stück}.
