...
\begin{enumerate}[label=(\alph*)]
  \item \textbf{Nennen} Sie die vier Hauptphasen des Teamentwicklungsmodells von Bruce Tuckman
  und ordnen Sie jeweils ein typisches Merkmal zu. \hfill (4~P.)
  ...
  wie Projektleiterin Ana Kovac darauf reagieren sollte. \hfill (4~P.)
...
\begin{enumerate}[label=(\alph*)]
  ...
  \item Das JIKU-Team plant folgende Foliensreihenfolge:\\[0.4em]
...
\begin{enumerate}[label=(\alph*)]
  \item Die vier Hauptphasen nach Tuckman:
  \begin{itemize}
...
\begin{enumerate}[label=(\alph*)]
  ...
  \begin{itemize}
    ...
    \item \textbf{Hauptteil:} Sachlogisch gegliederte Kernaussagen; Spannungsbogen halten; Beispiele verwenden. Zeitanteil ca. 70--75\,\%.
