...
Prokura kann nur von Kaufleuten (§§~1 ff.\ HGB) erteilt werden; Handlungsvollmachten stehen
ebenfalls nur Kaufleuten offen.
...
\begin{merksatz}[title={\bfseries Merke: GbR und MoPeG (seit 1.1.2024)}]
Seit dem Gesetz zur Modernisierung des Personengesellschaftsrechts (MoPeG, 1.1.2024) ist die
GbR rechtsfähig und kann freiwillig als eingetragene GbR (eGbR) ins Gesellschaftsregister
eingetragen werden. Betreibt eine GbR ein Handelsgewerbe, wird sie zur OHG.
\end{merksatz}
...
Mindestkapital & \textbf{25.000~€} Stammkapital (§~5 GmbHG); mind.\ 12.500~€ sofort einzuzahlen (§~7 Abs.~2 GmbHG) & \textbf{ab 1~€} Stammkapital; 25\,\% Thesaurierungspflicht & \textbf{50.000~€} Grundkapital (§~7 AktG)\\
...
(Beschlossen: schrittweise Senkung ab 2028 auf 10\,\% bis 2032.)
\end{merksatz}
