...
\addlinespace
Führungsprozess (Management\-prozess) & \emph{Didaktische Ergänzung: Im verwendeten Lehrwerk nicht als eigene Kategorie geführt, aber im Lernziel und in der Praxis gebräuchlich.} Führungs- bzw.\ Managementprozesse planen, steuern und kontrollieren die Kern- und Supportprozesse auf strategischer und operativer Ebene. Sie erzeugen keine direkte Wertschöpfung, sind aber für die Unternehmenssteuerung unerlässlich. Beispiele: Strategieentwicklung, Zielplanung, Unternehmenssteuerung, Qualitätsmanagement. \emph{Hinweis: Das Lehrwerk ordnet Controlling den Supportprozessen zu.}\\
\addlinespace
...
\textbf{Wertschöpfung} = Verkaufte Leistungen $\pm$ Lagerveränderung $-$ Vorleistungen $-$ Abschreibungen ~·~
